...
<head>
    ...
    <title>Content Mgt - Vlogshipped</title>
...
<body class="nav-md" ng-app="myApp">
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="s in students |  filter:search">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" ng-click="deleteContent(s.content_id)" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a> </td>
                                        </tr>
                                        <!-- END MODAL -->
                                    </tbody>
                                </table>
    ...
    <script>
        ...
        app.controller("myCtrl", function($http, $scope) {
            $http.get('../controller/studentController/allCont.php').then(function(response) {
                $scope.student_label = ["user_id","url", "description", "first_name", "last_name", "gender", "birthday", "user_type", "user_status", "email_address", "mobile_number", "ACTION"];
            ...
            $scope.deleteContent = function(stud_id) {
                console.log(stud_id);
                $('#deleteContent').modal('show');
                $('#delStud').on('click', function() {
                    $http.post('../controller/studentController/deleteCont.php', {
                        'stud_id': stud_id
                    }).then(function(response) {
                        location.reload();
