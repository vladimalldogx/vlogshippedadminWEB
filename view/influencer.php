...
<head>
    ...
    <title>Feedback Mgt(Users) - Vlogshipped</title>
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h1>User Account Feedback and Ratings</h1>
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="s in students |  filter:search">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" ng-click="deleteStudent(s.stud_id)" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a>
                                                <a href="#" ng-click="deleteStudent(s.stud_id)" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a> </td>
                                        </tr>
                                        <!-- END MODAL -->
                                    </tbody>
                                </table>
    ...
    <script>
        ...
        app.controller("myCtrl", function($http, $scope) {
            $http.get('../controller/studentController/allStud.php').then(function(response) {
                $scope.student_label = ["user id", "Firstname", "Lastname", "User Type", "Ratings",  "ACTION"];
            ...
            $scope.editStudent = function(stud_id) {
                $http.post('../controller/studentController/getInflu.php', {
                    'stud_id': stud_id
