					...
					<div class="col-md-12">
						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<!-- start project list -->
								<table class="table table-striped projects" id="datatable-buttons" style="overflow-x:auto;">
									<thead>
										<tr>
                                            <th> ID </th>
                                            <th> Title </th>
									...
									<tbody>
									    <?php foreach($cam as $x): ?>
										<tr>
                                            <td><?php echo $x['id'];?></td>
                                            <td><?php echo $x['title'];?></td>
                                            <td><?php echo $x['descrip'];?></td>
											...
											<td><?php echo $x['product_url'];?></td>
											<td><?php echo $x['photo_url'];?></td>
						...
						<button class="btn-btn-primary"><a href="contentReport.php">Go Back Content Report</a></button>
                    </div>
				</div>
            </div>
