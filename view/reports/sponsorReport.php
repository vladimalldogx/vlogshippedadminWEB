...
<head>
	...
	<title>Account Reports (Sponsor) | Vlogshipped</title>
			...
			<div class="right_col" role="main">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<table class="table table-striped projects" id="datatable-buttons" >
									...
									<tbody>
									    <?php foreach($spons as $x): ?>
										<tr>
                                            <td><?php echo $x['id'];?></td>
                                            <td><?php echo $x['user_type'];?></td>
                                            ...
                                            <td><?php echo $x['mobile_number'];?></td>
						...
						<button class="btn-btn-primary"><a href="influencerReport.php">Go Back Influencer Report</a></button>
                    </div>
				</div>
            </div>
