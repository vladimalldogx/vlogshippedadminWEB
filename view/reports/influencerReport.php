...
<head>
	...
	<title>Account Reports (Influencer) | Vlogshipped</title>
			...
			<div class="right_col" role="main">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<button class="btn-btn-primary"><a href="sponsorReport.php">Goto Sponsor Report</a></button>
                    </div>
				</div>
            </div>
