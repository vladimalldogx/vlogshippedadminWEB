...
<head>
    ...
    <title>Campaign Mgt - Vlogshipped</title>
...
<body class="nav-md" ng-app="myApp">
                                ...
                                <table class="table table-striped projects">
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="s in students |  filter:search">
                                            <td>{{ s.user_id}}</td>
                                            <td>{{ s.title}}</td>
                                            <td>{{ s.start_time}} {{s.start_date}}</td>
                                            <td>{{ s.end_time}} {{s.end_date}}</td>
                                            <td>{{ s.product_url}}</td>
                                            <td><img src={{s.photo_url}} alt="" height=100 width= 100></img> </td>
                                            <td>{{ s.descrip}}</td>
                                            <td>{{ s.first_name}}</td>
                                            <td>{{ s.last_name}}</td>
                                            <td>{{ s.gender}}</td>
    ...
    <script>
        ...
        app.controller("myCtrl", function($http, $scope) {
            $http.get('../controller/studentController/allCam.php').then(function(response) {
                $scope.student_label = ["user_id","title", "start", "end", "product_url", "photo_url", "description", "first_name", "last_name", "gender", "birthday", "user_type", "user_status", "email_address", "mobile_number", "ACTION"];
