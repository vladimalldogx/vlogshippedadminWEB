...
<head>
    ...
    <title>User Acc Mgt-Vlogshipped</title>
...
<body class="nav-md" ng-app="myApp">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                    View Usertype as:
                                    <select name="stud_yearLevel" required="required"  ng-model="blisterPackTemplateSelected" ng-change="changedValue(blisterPackTemplateSelected)" id="edit_stud_yearLevel" class="form-control">
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="s in students |  filter:search">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" ng-click="activateStudent(s.id)" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Activate </a>
                                                <a href="#" ng-click="deleteStudent(s.id)" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a> </td>
                                        </tr>
                                        <!-- END MODAL -->
                                    </tbody>
                                </table>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="activateStudent">
        <div class="modal-dialog" style="width:40%" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"> <span>&times;</span> </button>
                    ...
                    <div class="modal-footer">
                        <button class="btn button-secondary" data-dismiss="modal" type="button">Cancel</button>
                        <button class="btn btn-primary" id="activateStud">Activate</button>
                        <!-- </form> -->
                    </div>
                </div>
            </div>
