...
<body id="page-top" ng-app="myApp" ng-controller="myCtrl">
    ...
    <form method = "POST" action = "register.php">
		...
		<div class = "input-group">
			<input type = "text" required = "required" vaue = "" autofocus="true"  placeholder = "Username" name = "username">
			<input type = "text" required = "required" vaue = "" autofocus="true"  placeholder = "Password" name = "password">
			<input type = "text" required = "required" vaue = "" autofocus="true"  placeholder = "Confirm Password" name = "cnfrm_password">
			<input type = "text" required = "required" vaue = "" autofocus="true"  placeholder = "First Name" name = "firstname">
			<input type = "text" required = "required" vaue = "" autofocus="true"  placeholder = "Last Name" name = "lastname">

		</div>
			<button type = "submit" name = "register" class = "btn">Register</button><br>
			<br>
			
			<p>already have an account? <a href="adminlog.php"> Click here</a></p>
	...
	<!--<script>
        ...
        app.controller("myCtrl", function($http, $scope) {
			...
			$scope.register = function(stud_id) {
                console.log(stud_id);
                $('#Register').on('click', function() {
                    
                    $http.post('../controller/studentController/registerAdmin.php', {
                        'username' : $('#tusername').val(),
                        'password' : $('#tpassword').val(),
						'cnfrm_password' : $('#tcnfrm_password').val(),
